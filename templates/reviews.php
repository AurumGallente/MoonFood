        ...
        <section class="slide-bg section" style="background: url('images/template4.jpg') no-repeat;">
                            ...
                            <div class="slider-on-page col-xs-12 col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-1">
                                <div class="slider-on-page__slide recall">
                                    <div class="recall__name">
                                        <h2><span class="name">Анна</span>, 36 лет</h2>
                                    </div>
                                ...
                                <div class="slider-on-page__slide recall">
                                    <div class="recall__name">
                                        <h2><span class="name">Сергей</span>, 29 лет</h2>
                                    </div>
                                    <div class="recall__description">
                                        <div class="description__concret-recall">
                                            <p>
                                                "Работаю с утра до ночи и часто не хватает времени даже на легкий перекус, но благодаря Mood Food, я восполняю полноценный завтрак и обед, я чувствую легкость в организме и заряд энергии на весь день."
                                            </p>
                                        </div>
                                    </div>
                                </div>
